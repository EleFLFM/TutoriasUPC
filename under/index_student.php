...
<head>
    ...
    <title>Cursos Activos - UPC</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid" style="left: 5%; position: relative;">
                    <div class="text-center">
                        <h1 class="h4 text-gray-900 mb-4">Cursos Activos</h1>
                    </div>
                    <div class="row">
                            <?php
                            ...
                            // Consulta para obtener los cursos activos en los que está matriculado el estudiante
                            $sql = "SELECT c.code, c.descripcion, c.semestre, 
                                    ...
                                    WHERE ec.usuario_id = ? 
                                    AND c.id_estado = 1 
                                    AND (u.id_estado = 1 OR u.nombre IS NULL)"; 
                            $stmt = $conn->prepare($sql);
                            $stmt->bind_param("i", $estudiante_id);
                            $stmt->execute();
                            $result = $stmt->get_result();
                            
                            // Verificar si el estudiante está matriculado en algún curso activo
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            ...
                            <div class="col-auto">
                                ...
                                echo "<div class='col-12'><p class='alert alert-info text-center'>No tienes cursos activos matriculados.</p></div>";
                            }
